...
var _user$project$Model$Model = F2(
	function (a, b) {
		return {songs: a, activeSong: b};
	});
var _user$project$Model$Song = F3(
	function (a, b, c) {
		return {audioUrl: a, description: b, title: c};
	});
var _user$project$Model$SelectRandomSong = {ctor: 'SelectRandomSong'};
var _user$project$Model$SelectSong = function (a) {
	return {ctor: 'SelectSong', _0: a};
};
var _user$project$Model$SongsFeedLoaded = function (a) {
	return {ctor: 'SongsFeedLoaded', _0: a};
};
var _user$project$Model$SongsLoad = {ctor: 'SongsLoad'};
var _user$project$Model$Noop = {ctor: 'Noop'};

var _user$project$View$viewPlayer = function (song) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src(song.audioUrl),
						_1: {
							ctor: '::',
...
var _user$project$View$onClickPreventDefault = function (msg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
...
var _user$project$View$viewApp = function (model) {
	var _p0 = model.songs;
	switch (_p0.ctor) {
		case 'NotAsked':
			return _elm_lang$html$Html$text('Not asked yet');
		case 'Loading':
		...
		case 'Success':
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$core$Maybe$withDefault,
						_elm_lang$html$Html$text('No song selected'),
						A2(_elm_lang$core$Maybe$map, _user$project$View$viewPlayer, model.activeSong)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											ctor: '::',
											_0: _user$project$View$onClickPreventDefault(_user$project$Model$SelectRandomSong),
											_1: {ctor: '[]'}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Play random song!'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_elm_lang$html$Html$a,
													{
														...
														_1: {
															ctor: '::',
															_0: _user$project$View$onClickPreventDefault(
																_user$project$Model$SelectSong(song)),
															_1: {ctor: '[]'}
														}
													},
													{
		...
		default:
			return _elm_lang$html$Html$text('Error during loading');
	}
};
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$viewApp(model),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Music from '),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$a,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('http://musicforprogramming.net/'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('musicforprogramming.net'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Update$songDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Song))));
var _user$project$Update$songsDecoder = _elm_lang$core$Json_Decode$list(_user$project$Update$songDecoder);
var _user$project$Update$fullDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'items',
	...
	_user$project$Update$songsDecoder);
var _user$project$Update$randomSong = function (songs) {
	var length = _elm_lang$core$List$length(songs);
	return A2(
		_elm_lang$core$Random$map,
		function ($int) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				{audioUrl: '', title: '', description: ''},
				A2(_elm_community$list_extra$List_Extra$getAt, $int, songs));
		},
		A2(_elm_lang$core$Random$int, 0, length - 1));
};
var _user$project$Update$getSongs = function () {
	var url = 'music.json';
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Model$SongsFeedLoaded,
		A2(
			_elm_lang$http$Http$send,
			_krisajenkins$remotedata$RemoteData$fromResult,
			A2(_elm_lang$http$Http$get, url, _user$project$Update$fullDecoder)));
}();
			...
			case 'SongsLoad':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{songs: _krisajenkins$remotedata$RemoteData$Loading}),
					_1: _user$project$Update$getSongs
				};
			case 'SongsFeedLoaded':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'SelectSong':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							activeSong: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				...
				if (_p1.ctor === 'Success') {
					return {
						...
						_1: A2(
							_elm_lang$core$Random$generate,
							_user$project$Model$SelectSong,
							_user$project$Update$randomSong(_p1._0))
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
...
var _user$project$Main$init = A2(
	...
	_user$project$Model$SongsLoad,
	{songs: _krisajenkins$remotedata$RemoteData$NotAsked, activeSong: _elm_lang$core$Maybe$Nothing});
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Main$init, update: _user$project$Update$update, view: _user$project$View$view, subscriptions: _user$project$Update$subscriptions})();
